...
Manages municipal withholdings (Retenciones Municipales) applied to local economic activities, industry, and commerce licenses across Venezuelan municipalities.
...
Configure municipal withholding rates and accounts per municipality and activity code in company settings.

## Usage

Generate and manage municipal withholding vouchers from vendor bills and customer invoices.
...
This module is part of the [OCA/l10n-venezuela](https://github.com/OCA/l10n-venezuela/tree/14.0/l10n_ve_withholding_muni) project on GitHub.
