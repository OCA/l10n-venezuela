...
globalThis.QUnit.module("Account Reports Builder", ({beforeEach}) => {
    beforeEach(async () => {
        arch = `
            <form>
        ...
        // Make fixture in visible range, so that globalThis.document.elementFromPoint work as expected
        target.style.position = "absolute";
        target.style.top = "0";
        target.style.left = "0";
        target.style.height = "100%";
        target.style.opacity = globalThis.QUnit.config.debug ? "" : "0";
    ...
    // Structure
    // ------------------------------------------------------------------------------------------------------------------
    globalThis.QUnit.test("have correct descendants count", async (assert) => {
        await makeView({
            type: "form",
            resId: 1,
            resModel: "report",
    ...
    // Create
    // ------------------------------------------------------------------------------------------------------------------
    globalThis.QUnit.test("can create a line", async (assert) => {
        await makeView({
            type: "form",
            resId: 1,
            resModel: "report",
    ...
    // Edit
    // ------------------------------------------------------------------------------------------------------------------
    globalThis.QUnit.test("can edit a line", async (assert) => {
        await makeView({
            type: "form",
            resId: 1,
            resModel: "report",
    ...
    // Delete
    // ------------------------------------------------------------------------------------------------------------------
    globalThis.QUnit.test("can delete a root", async (assert) => {
        await makeView({
            type: "form",
            resId: 1,
            resModel: "report",
    ...
    globalThis.QUnit.test("can delete a root with children", async (assert) => {
        await makeView({
            type: "form",
            resId: 1,
            resModel: "report",
    ...
    globalThis.QUnit.test("can delete a last child", async (assert) => {
        await makeView({
            type: "form",
            resId: 1,
            resModel: "report",
    ...
    // Drag and drop
    // ------------------------------------------------------------------------------------------------------------------
    globalThis.QUnit.test("can move a root down", async (assert) => {
    ...
    globalThis.QUnit.test("can move a root up", async (assert) => {
        serverData.models.report.records[0].line_ids = [1, 2, 3, 4];
        serverData.models.report_lines.records = [
            {
                id: 1,
    ...
    globalThis.QUnit.test("can move a child down", async (assert) => {
        serverData.models.report.records[0].line_ids = [1, 2, 3, 4];
        serverData.models.report_lines.records = [
            {
                id: 1,
    ...
    globalThis.QUnit.test("can move a child up", async (assert) => {
    ...
    globalThis.QUnit.test("can move a new root into a child", async (assert) => {
        serverData.models.report.records[0].line_ids = [1, 2, 3];
        serverData.models.report_lines.records = [
            {
                id: 1,
    ...
    globalThis.QUnit.test("can move a child into a new root", async (assert) => {
