...
export class Asserts {
    ...
    static getCount(target, selector) {
        return globalThis.document.querySelector(target).querySelectorAll(selector)
            .length;
    }
    ...
    static check(condition, success, error) {
        if (condition) {
            Asserts.success(success);
        } else {
            Asserts.error(error);
        }
    }
    static success(message) {
        return globalThis.console.info(`SUCCESS: ${message}`);
    }
    ...
    static hasClass(selector, classname) {
        Asserts.check(
            globalThis.document.querySelector(selector).classList.contains(classname),
