...
export class AccountReportListRenderer extends ListRenderer {
    ...
    onDragStart(ctx) {
        ...
        globalThis.document
            .querySelector(".o_nested_sortable_placeholder")
            .after(placeholder);
    }

    onDragEnd() {
        // Clear placeholder
        globalThis.document.querySelector(".o_dragged_placeholder").remove();
    }
    ...
    async setRecordHierarchy(currentElement, parentElement) {
        ...
        for (
            ...
            if (parentHierarchyLevel !== null && parentHierarchyLevel !== undefined) {
    ...
    async setRecordSequence(
        ...
        let newCurrentRecordIndex = null;
