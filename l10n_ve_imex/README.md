...
Manages customs import declarations (DUA - Declaración Única de Aduanas) and export declarations for Venezuelan international trade compliance.
...
Set up customs office codes and declaration sequences in configuration.

## Usage

Link DUA numbers and customs declarations to import vendor bills to justify foreign currency transactions and nationalization taxes.
...
This module is part of the [OCA/l10n-venezuela](https://github.com/OCA/l10n-venezuela/tree/14.0/l10n_ve_imex) project on GitHub.
