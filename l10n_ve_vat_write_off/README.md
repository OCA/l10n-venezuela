...
Allows fiscal adjustment and write-off of non-deductible VAT credits according to Venezuelan tax provisions.
...
Configure write-off expense accounts in accounting configuration.

## Usage

Create VAT Write Off vouchers to balance non-deductible VAT entries against corresponding expense accounts.
...
This module is part of the [OCA/l10n-venezuela](https://github.com/OCA/l10n-venezuela/tree/14.0/l10n_ve_vat_write_off) project on GitHub.
