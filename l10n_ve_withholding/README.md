...
Base module providing the core architecture and shared data structures for all Venezuelan withholding engines (VAT, ISLR, Municipal, and Social Responsibility).
...
This is a technical base module automatically configured when installing specific withholding engines.

## Usage

Adds the withholding status tracker (*Not Withheld*, *Partially Withheld*, *Withheld*) to invoices and moves.
...
This module is part of the [OCA/l10n-venezuela](https://github.com/OCA/l10n-venezuela/tree/14.0/l10n_ve_withholding) project on GitHub.
