...
class AccountPaymentGroup(models.Model):
    ...
    selected_debt_taxed = fields.Monetary(
        string="Selected Debt taxed", compute="_compute_selected_debt",
    )
    ...
    partner_regimen_islr_ids = fields.Many2many(
        "seniat.tabla.islr", compute="_compute_partner_regimenes_islr",
    )
    ...
    selected_debt_currency_id = fields.Many2one(
        "res.currency", string="Selected Debt in foreign currency",
    )
        ...
        for rec in self:
            ...
            for line in rec.to_pay_move_line_ids._origin:
                ...
                if line.move_id.currency_id != rec.company_id.currency_id:
                    ...
                    line.move_id.currency_id != rec.company_id.currency_id
