...
Integrates ISLR withholding concepts directly into Sale Orders and Purchase Orders lines, forecasting withholding amounts prior to invoice generation.
...
Enable ISLR concept selection on sales and purchase line settings.

## Usage

Select ISLR concepts directly on quotation lines; these are automatically transferred to generated invoices.
...
This module is part of the [OCA/l10n-venezuela](https://github.com/OCA/l10n-venezuela/tree/14.0/l10n_ve_sale_purchase) project on GitHub.
