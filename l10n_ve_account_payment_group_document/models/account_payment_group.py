...
class AccountPaymentGroup(models.Model):
    ...
    name = fields.Char(string="Document Reference", copy=False,)
    ...
    @api.depends("receiptbook_id.sequence_id.number_next_actual",)
    ...
    def post(self):
        for rec in self:
            ...
            super(
                AccountPaymentGroup,
                self.with_context(
                    default_l10n_latam_document_type_id=rec.document_type_id.id
                ),
            ).post()
