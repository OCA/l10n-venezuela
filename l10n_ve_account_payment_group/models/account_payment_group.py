...
class AccountPaymentGroup(models.Model):
    ...
    payments_amount = fields.Monetary(
        compute="_compute_payments_amount", string="Amount", track_visibility="always",
    )
    ...
    has_outstanding = fields.Boolean(compute="_compute_has_outstanding",)
    ...
    def action_payment_sent(self):
        ...
        template = self.env.ref(
            "l10n_ve_account_payment_group.email_template_edi_payment_group", False
        )
    ...
    def payment_print(self):
        ...
        return self.env.ref(
            "l10n_ve_account_payment_group.action_report_payment_group"
        ).report_action(self)
    ...
    def _compute_matched_move_line_ids(self):
        ...
        for rec in self:
            ...
            rec.matched_move_line_ids = (
                payment_lines.mapped("matched_debit_ids.debit_move_id")
                | payment_lines.mapped("matched_credit_ids.credit_move_id")
            ) - payment_lines
