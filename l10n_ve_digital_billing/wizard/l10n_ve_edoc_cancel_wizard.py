...
class L10nVeEdocCancelWizard(models.TransientModel):
    ...
    move_id = fields.Many2one(
        comodel_name="account.move", string="Document",
    ...
    def action_confirm(self):
        ...
        if move.l10n_ve_edoc_state not in ("sent", "assigned"):
            raise UserError(_(
                "%s was not issued at the digital printing house.",
                move.display_name))
        ...
        return {
            ...
            "params": {
                "type": "danger",
                "title": _("The printing house did not accept the cancellation"),
                "message": move.l10n_ve_edoc_error
                or _("Check the digital printing house log."),
                "sticky": True,
            },
        }
